...
{
    internal static class AnimatorParameterTypeConversionUtility
    {
        internal static bool IsSupportedType(AnimatorControllerParameterType type)
        {
        ...
        internal static AnimatorControllerParameter ApplyTypeConversion(
            ...
            AnimatorControllerParameterType targetType)
        {
            ...
            AnimatorControllerParameterType sourceType = parameter.type;
        ...
        internal static AnimatorCondition ConvertCondition(
            ...
            AnimatorControllerParameterType toType)
        {
            ...
            AnimatorCondition converted = condition;
        ...
        private static bool ResolveBoolValue(AnimatorControllerParameter parameter)
        {
            switch (parameter.type)
            {
                ...
                case AnimatorControllerParameterType.Float:
                    return parameter.defaultFloat >= 0.5f;
                case AnimatorControllerParameterType.Int:
