...
namespace MVA.Toolbox.AnimationSwitchTool
{
    // 右键菜单 / 快捷键：在 Animation 窗口中切换同一物体上的 AnimationClip
    [InitializeOnLoad]
    internal static class AnimationSwitchTool
    {
        ...
        internal static void SwitchToPreviousClip()
        {
            CallSwitch(isNext: false);
        }

        internal static void SwitchToNextClip()
        {
            CallSwitch(isNext: true);
        }

        internal static bool ValidateClipMenu()
        {
